...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"景冉","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 109:
/*!***************************************!*\
  !*** G:/景冉/workspace/common/image.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 18:
/*!************************************!*\
  !*** G:/景冉/workspace/utils/api.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var _require = __webpack_require__(/*! ./request.js */ 19),request = _require.request; //引入封装好的js文件
module.exports = {
  //用户登录
  ...
  foodDetail: function foodDetail(fid, uid) {
  ...
  //根据id获取攻略详情页数据
  tipsDetail: function tipsDetail(id) {
  ...
  // 获取收藏列表
  getCollect: function getCollect(uid, state) {
    return request("/store/list/".concat(uid, "/").concat(state), 'GET');
  },

  //发布论坛
  pubSpace: function pubSpace() {
  ...
  //更新用户密码
  updateUserPass: function updateUserPass(Body) {
    return request("/user/updatePass", 'POST', Body);
  },
  //修改昵称
  updateUserName: function updateUserName(Data) {
    return request("/user/changeName", 'POST', Data);
  },
  // 酒店详情
  getStay: function getStay(accommodationId, uid) {
    return request("/accommodation/getDetailAccommodationInfo/".concat(accommodationId, "/").concat(uid), 'POST');
  },
  // 收藏
  uqdateCollect: function uqdateCollect(data) {
    return request("/store/addStore", 'POST', data);
  },
  // 取消收藏
  delCollect: function delCollect(e) {
    return request('/store/delStore', 'POST', e);
  },
  pubComment: function pubComment(data) {
    return request('/comments/addCommend', 'POST', data);
  },
  //搜索框
  searchItems: function searchItems(data) {
...
/***/ 19:
/*!****************************************!*\
  !*** G:/景冉/workspace/utils/request.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

var BASEURL = 'http://43.136.171.8:10001/';
...
/***/ 84:
/*!*******************************************************!*\
  !*** G:/景冉/workspace/common/index/index.post.data.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
